...
#. Go back to Postman once again and select the request **Get-Retrieve Phone and Mail Attributes** and click **Send** another time. Note this is done at the main Postman window, not in Runner.
